...
public class Program
{
    static void Main(string[] args)
    {
        ...
        while (isWork)
        {
            ...
            CalculationNextPosition(pressedKey, pacmanX, pacmanY, map, out nextPacmanPositionX, out nextPacmanPositionY,
                out nextCell);
    ...
    private static void CalculationNextPosition(ConsoleKeyInfo pressdKey, int pacmanX, int pacmanY, char[,] map,
        out int nextPacmanPositionX, out int nextPacmanPositionY, out char nextCell)
    {
    ...
    private static void TryMove(char nextCell, int nextPacmanPositionX, int nextPacmanPositionY, ref int pacmanX,
        ref int pacmanY)
    {
        char wall = '#';
    ...
    private static void TryCollectScore(char nextCell, ref int score, char[,] map, int nextPacmanPositionX,
        int nextPacmanPositionY)
    {
        char scoreItem = '.';
